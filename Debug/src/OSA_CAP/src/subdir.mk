...
src/OSA_CAP/src/%.o: ../src/OSA_CAP/src/%.cpp
	...
	/usr/local/cuda-8.0/bin/nvcc -I/usr/include/opencv -I/usr/lib/gcc-cross/aarch64-linux-gnu/5/include -I../src/OSA_CAP/inc -I/usr/include -I/usr/include/opencv2 -I../inc -G -g -O0 -Xcompiler -fPIC -Xcompiler -fopenmp -ccbin aarch64-linux-gnu-g++ -gencode arch=compute_50,code=sm_50 -m64 -odir "src/OSA_CAP/src" -M -o "$(@:%.o=%.d)" "$<"
